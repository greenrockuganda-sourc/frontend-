...
// Railway injects API_BASE_URL when configured. Keep the deployed backend as the
// default so local frontend runs against the hosted backend unless env vars are
// explicitly set to another target.
